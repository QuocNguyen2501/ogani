...
func main() {
	...
	prodBrandHandler := productBrandHandler.CreateProductBrandHandler()
	prodTypeHandler := productTypeHandler.CreateProductTypeHandler()
	...
	v1.Get("/product/catalogtypes", prodTypeHandler.ProductTypes)
	v1.Get("/product/catalogbrands", prodBrandHandler.ProductBrands)
